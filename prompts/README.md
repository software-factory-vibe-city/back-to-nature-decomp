...
the function decompilation skill. It includes the target-schedule and generic
scheduler-state SAT/UNSAT workflow, while deriving concrete target/toolchain
facts from `configs/project-profile.md`.

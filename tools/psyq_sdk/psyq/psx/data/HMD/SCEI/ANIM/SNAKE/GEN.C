...
/*
	...
	usage: gen [-v|-div num|-tframe num|-speed num] >a.lab

	Copyright (C) 1997 by Sony Computer Entertainment Inc.
	All rights Reserved.

	Ver 1.00	Sep 10, 1997	by N.Yoshioka
	Ver 1.01	Sep 12, 1997	by N.Yoshioka
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
put_anim_set(void)
{
	...
	for (i = 0; i < NUM_RINGS; i++) {
		...
		printf("\tH(0); H(0);\t/* rframe(fixed), tframe */\n");
		printf("\tH(0); H(0);\t/* ctr idx, tctr idx */\n");
		printf("\tH((Ctrl_%04d - CtrlSect) / 4); B(0); B(0);", i);

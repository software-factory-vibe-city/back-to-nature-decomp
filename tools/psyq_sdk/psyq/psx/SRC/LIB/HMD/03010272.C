...
/* hokan driver */
int GsU_03010272(GsARGUNIT_ANIM *sp0)
{
  u_char *dtop;
  u_long ofs0,ofs1;
  GsSEQ *seq;
  ...
  *dtop = ((((((((co[0][0]*t)>>16)+co[0][1])*t)>>16)+co[0][2]) *t)>>16)+co[0][3];
  *(dtop+1) = ((((((((co[1][0]*t)>>16)+co[1][1])*t)>>16)+co[1][2]) *t)>>16)+co[1][3];
  *(dtop+2) = ((((((((co[2][0]*t)>>16)+co[2][1])*t)>>16)+co[2][2]) *t)>>16)+co[2][3];

...
/* divide primitives and register to OT*/
/* u_long *ot;		/* OT						*/
/* SVECTOR *x0...*x3;	/* vertex of the polygon				*/
/* POLY_FT4 *tmpl;	/* templete */
/* int ndiv;		/* division order */
/* POLY_FT4 *heap;	/* primitive buffer */
/* u_long *scratch:;	/* scratch pad address */

...
/*
 * Flat Triangle (GsUGT3)
 */
u_long *GsU_f000000d(GsARGUNIT *sp)
{
	POLY_GT3		*pp;
	LINE_F2			*pf2;
	HMD_P_GT3 		*tp;
	...
	int			i, j;
	SVECTOR			vv[1];
	CVECTOR			code = {0x80, 0x80, 0x80, 0x34};
	...
	ap->primp++;
	tp = (HMD_P_GT3 *)(ap->primtop+(*(ap->primp)));

...
/*
 * Active Sub-divide Non-light Flat Texture Quad (GsU_000c0051)
 */
u_long *GsU_000c0051(GsARGUNIT *sp)
{
	register GsADIV_FT4	*ifo;
	register HMD_P_NFT4	*tp;
	...
	ap->primp++;
	tp = (HMD_P_NFT4 *)(ap->primtop+(*(ap->primp)&0x00ffffff));

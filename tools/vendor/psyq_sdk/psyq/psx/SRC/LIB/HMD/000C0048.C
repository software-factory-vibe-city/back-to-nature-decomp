...
/*
 * Active Sub-divide Non-light Flat Triangle (GsU_000c0048)
 */
u_long *GsU_000c0048(GsARGUNIT *sp)
{
	register GsADIV_F3	*ifo;
	register HMD_P_NF3	*tp;
	...
	ap->primp++;
	tp = (HMD_P_NF3 *)(ap->primtop+(*(ap->primp)&0x00ffffff));

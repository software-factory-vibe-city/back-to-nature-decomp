...
/*
 * Camera primitive (FIX)
 */
u_long *GsU_07020100(GsARGUNIT *sp)
{
	...
	gte_rotate_z_matrix(&GsWSMATRIX, -cp->vrz);
	...
	ApplyMatrixLV(&mat2, (VECTOR *) & mat.t[0], &tmp);
	mat2.t[0] = -tmp.vx;
	mat2.t[1] = -tmp.vy;
	mat2.t[2] = -tmp.vz;
	GsMulCoord2(&GsWSMATRIX, &mat2);
	GsWSMATRIX = mat2;

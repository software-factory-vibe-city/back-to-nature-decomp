...
/*
 * Active Sub-divide Non-light Gouraud Texture Quad (GsU_000c0055)
 */
u_long *GsU_000c0055(GsARGUNIT *sp)
{
	register GsADIV_GT4	*ifo;
	register HMD_P_NGT4	*tp;
	...
	ap->primp++;
	tp = (HMD_P_NGT4 *)(ap->primtop+(*(ap->primp)&0x00ffffff));

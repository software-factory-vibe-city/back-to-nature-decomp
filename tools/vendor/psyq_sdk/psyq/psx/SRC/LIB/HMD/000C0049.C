...
/*
 * Active Sub-divide Non-light Flat Texture Triangle (GsU_000c0049)
 */
u_long *GsU_000c0049(GsARGUNIT *sp)
{
	register GsADIV_FT3	*ifo;
	register HMD_P_NFT3	*tp;
	...
	ap->primp++;
	tp = (HMD_P_NFT3 *)(ap->primtop+(*(ap->primp)&0x00ffffff));

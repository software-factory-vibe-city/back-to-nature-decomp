...
/* hokan driver */
int GsU_03010371(GsARGUNIT_ANIM *sp0)
{
  MYVECTOR *dtop;
  u_long ofs0,ofs1;
  GsSEQ *seq;
  ...
  dtop = (MYVECTOR *)((u_long *)(*(&(sp0->header_size)+ofs0))+ofs1);
  
  dtop->vx = ((((((((co[0][0]*t)>>16)+co[0][1])*t)>>16)+co[0][2])
	       *t)>>16)+co[0][3];
  dtop->vy = ((((((((co[1][0]*t)>>16)+co[1][1])*t)>>16)+co[1][2])
	       *t)>>16)+co[1][3];
  dtop->vz = ((((((((co[2][0]*t)>>16)+co[2][1])*t)>>16)+co[2][2])
	       *t)>>16)+co[2][3];

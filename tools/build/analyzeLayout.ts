 ...
 *
 * Usage: npx tsx tools/build/analyzeLayout.ts
...
import { loadPsxExeInfo, type PsxExeInfo } from "../lib/psxExeInfo.ts";
...
function generateReport(
  ...
  lines.push("");
  lines.push("Generated by `tools/build/analyzeLayout.ts`");

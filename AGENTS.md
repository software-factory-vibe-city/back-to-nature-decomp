...
- `configs/` — `splat.yaml`, `symbol_addrs.txt`, `flag_overrides.mk`, `project-info.json` (human facts), `project-profile.md` (auto-generated by `genProjectProfile.ts`, injected into agent prompts)

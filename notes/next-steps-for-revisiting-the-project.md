...
For each of the 18 register-pinned files and 2 flag-override files: strip the
hack, run `diffFunc`, keep it stripped if still 100%. CopyVec3 suggests a
meaningful fraction will match clean. Script it; minutes of work.

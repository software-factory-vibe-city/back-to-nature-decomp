...
Members (address order):
- func_800245F4–func_80024A10 (14 wrappers, 6× m + 8× s) — thin wrappers with
  ...
  of the four 0x27 wrappers), func_8002469C (m) matched (id 0x27 — third
  of the four 0x27 wrappers, frame 1 passthrough of $a0 with arg3 = $a1 sext,
  arg4 = $a2 sext on stack), func_800248B0 (m) matched (id 0xB),
